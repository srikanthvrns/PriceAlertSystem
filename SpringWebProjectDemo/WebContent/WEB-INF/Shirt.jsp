  ...
  <%--   		<li>${user1.firstname}</li>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Indigo Nation</div>
        ...
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post">
   				...
   				<input type="hidden" value="${user1.carrier}" name="carrier">
   				<button name="itemId" class="btn btn-primary btn-block" value="10003" type="submit">View Details</button>
<!--    				<a class="btn btn-primary btn-block" href="#" role="button" align="center" name="Buy" value="10003" onclick="submit();">View Details</a> -->
   			</form>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">IZOD Light</div>
        ...
        <div class="panel-footer">
        	...
        	<input type="hidden" value="${user1.email}" name="email">
        	<input type="hidden" value="${user1.carrier}" name="carrier">
   				<!-- <a class="btn btn-primary btn-block" href="#" role="button" align="center" name="Buy" value="10004" onclick="submit();">View Details</a>
   			 -->	<button name="itemId" class="btn btn-primary btn-block" value="10004" type="submit">View Details</button>
   			</form>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">GAP Slim</div>
        <div class="panel-body"><img src="images/shirt3.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post" >
   				<!-- <a class="btn btn-primary btn-block" href="#" role="button" align="center" name="Buy" value="10008" onclick="submit();">View Details</a>
   --> 			<input type="hidden" value="${user1.userid}" name="userid">	
   				<input type="hidden" value="${user1.email}" name="email">
   				<input type="hidden" value="${user1.carrier}" name="carrier">
   				<button name="itemId" class="btn btn-primary btn-block" value="10008" type="submit">View Details</button>
