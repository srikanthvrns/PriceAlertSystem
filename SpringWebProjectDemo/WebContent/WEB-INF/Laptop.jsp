  ...
  <body>
   <div class="navbar-wrapper">
    ...
    <div class="container marketing">
		<ol class="breadcrumb">
    		<li><a href="/SpringWebProjectDemo/Home.html">Home</a></li>
    		<li><a href="/SpringWebProjectDemo/Gadgets.html">Gadgets</a></li>
    		<li class="active">Laptop</a></li>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Apple McBook Pro</div>
        <div class="panel-body"><img src="images/laptop1.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post">
				<input type="hidden" value="${user1.userid}" name="userid">
   				...
   				<button name="itemId" class="btn btn-primary btn-block" value="10011" type="submit">View Details</button>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Dell Alienware</div>
        <div class="panel-body"><img src="images/laptop2.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post">
				<input type="hidden" value="${user1.userid}" name="userid">
 		       	<input type="hidden" value="${user1.email}" name="email">
   				<button name="itemId" class="btn btn-primary btn-block" value="10002" type="submit">View Details</button>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Acer Iconia</div>
        <div class="panel-body"><img src="images/laptop3.jpeg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post">
   						<input type="hidden" value="${user1.userid}" name="userid">
 		       	<input type="hidden" value="${user1.email}" name="email">
   				<button name="itemId" class="btn btn-primary btn-block" value="10012" type="submit">View Details</button>
