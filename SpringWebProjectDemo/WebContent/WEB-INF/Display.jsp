...
<th>ITEM_CATEGORY</th>
				...
				<td>${itemList.itemModel}</td>
				<td>${itemList.itemColor}</td>
				<td>${itemList.itemCategory}</td>
				<tr>
					
</table>

<form action="/SpringWebProjectDemo/setAlert.html" method="post">
<input type="hidden" value="${user1.userid}" name="userId">
<input type="hidden" value="${user1.email}" name="email">
<input type="hidden" value="${itemList.itemId}" name="itemId">
<input type="hidden" value="${user1.carrier}" name="carrier">
<button name=alert type="submit" value="Alert">ALERT</button>
</form>		
