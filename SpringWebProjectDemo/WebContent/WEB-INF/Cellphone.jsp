  ...
  <body>
    ...
    <div class="container marketing">
		<ol class="breadcrumb">
    		...
    		<li class="active">CellPhone</a></li>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/cellphone1.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post">
 				<input type="hidden" value="${user1.userid}" name="userid">
   				...
   				<button name="itemId" class="btn btn-primary btn-block" value="10001" type="submit">View Details</button>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/cellphone2.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post">
   				<input type="hidden" value="${user1.userid}" name="userid">
 		       	<input type="hidden" value="${user1.email}" name="email">
   				<button name="itemId" class="btn btn-primary btn-block" value="10009" type="submit">View Details</button>
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Google Nexus 6P</div>
        <div class="panel-body"><img src="images/cellphone3.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">
        	<form action="/SpringWebProjectDemo/Detail.html" method="post">
   				<input type="hidden" value="${user1.userid}" name="userid">
 		       	<input type="hidden" value="${user1.email}" name="email">
   				<button name="itemId" class="btn btn-primary btn-block" value="10010" type="submit">View Details</button>
