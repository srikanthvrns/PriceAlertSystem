...
public class PhoneController {
	...
	public void sendMessages(List<Alert> alertList,String name,double oldPrice,double newPrice) {
		...
		// String[] to = {"srikanthvrns@gmail.com","bnswain@gmail.com","shridhar.yadav88@gmail.com"};//change accordingly  
		 ...
		 for(int i=0;i<alertList.size();i++){
			 try {
				cc[i] = new InternetAddress(alertList.get(i).getCarrier());
			} catch (Exception e) {
	  ...
	  try {  
	   ...
	   message.setSubject("Alert From Website: PRODUCT NAME - "+name+"\n");  
	   message.setText("\n ITEM NAME "+name+" \n OLD PRICE "+oldPrice +" \n NEW PRICE "+newPrice);  
